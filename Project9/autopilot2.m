...
%    bz       = uu(19+NN); % z-gyro bias
    ...
    switch autopilot_version
        ...
        case 2,
           [delta, x_command] = autopilot_uavbook(Va_c,h_c,phi_c,Va,h,chi,phi,theta,p,q,r,t,P);
        case 3,
...
%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%
function [delta, x_command] = autopilot_uavbook(Va_c,h_c,phi_c,Va,h,chi,phi,theta,p,q,r,t,P)
